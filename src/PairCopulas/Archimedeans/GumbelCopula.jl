...
@inline _pair_logpdf(C::Copulas.GumbelCopula{2}, u::Real, v::Real, ::Vector{Float64},) = _gumbel_pair_logpdf(C, _clp(u), _clp(v),)
...
@inline hfunc1(C::Copulas.GumbelCopula{2}, u::Real, v::Real,) = _clp(_gumbel_hfunc(C, _clp(u), _clp(v),),)
@inline hfunc2(C::Copulas.GumbelCopula{2}, u::Real, v::Real,) = _clp(_gumbel_hfunc(C, _clp(v), _clp(u),),)
...
@inline _gumbel_hinv(C::Copulas.GumbelCopula{2}, q::Real, base::Real,) = _gumbel_hinv_from_theta(_vine_params(C).θ, q, base)
@inline hinv1(C::Copulas.GumbelCopula{2}, q::Real, v::Real,) = _clp(_gumbel_hinv(C, _clp(q), _clp(v),),)
@inline hinv2(C::Copulas.GumbelCopula{2}, q::Real, u::Real,) = _clp(_gumbel_hinv(C, _clp(q), _clp(u),),)
