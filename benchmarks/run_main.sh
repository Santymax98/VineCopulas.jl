...
julia --project=benchmarks benchmarks/summarize_evaluation.jl

echo
echo "Evaluation benchmark complete."
echo "  results: benchmarks/results/"
echo "  report:  benchmarks/reports/benchmark_summary.md"
