...
The public constructors keep the parameter domains defined by `Copulas.jl`. Automatic vine selection can use a narrower candidate domain; see [Controls and parameter domains](../../fitting/controls.md).
