...
|---|---:|---|---:|---:|
| `:mle` | 1 | `false` | 254.4 | — |
| `:mle` | 1 | `true` | 259.2 | 1.0× |
| `:mle` | 4 | `true` | 69.7 | 3.6× |
| `:mle` | 8 | `true` | 43.5 | 5.8× |
| `:mle` | 16 | `true` | 34.2 | 7.4× |
| `:itau` | 1 | `false` | 14.4 | — |
| `:itau` | 1 | `true` | 16.5 | 0.9× |
| `:itau` | 4 | `true` | 6.9 | 2.1× |
| `:itau` | 16 | `true` | 5.2 | 2.8× |
...
per core); the `:itau` fit spends most of its
time in the sequential parts (dependence weights, the spanning tree, the
h-function propagation), which the keyword does not touch. Reproduce a row with
